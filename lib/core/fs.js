...
module.exports = siapi => {
  function normalizePath(optPath) {
    ...
    return path.join(siapi.dir, normalizedPath);
  }

  const siapiFS = {
    /**
     * Writes a file in a siapi app
    ...
    writePluginFile(plugin, optPath, data) {
      ...
      return siapiFS.writeAppFile(newPath, data);
    },

    /**
     * Removes a file in siapi app
     */
