...
module.exports = async (entry, files, { model, source }) => {
  const entity = siapi.getModel(model, source);

  if (!_.has(siapi.plugins, 'upload')) return entry;
